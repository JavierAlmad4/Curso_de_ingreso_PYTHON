...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        txt_sueldo = float(self.txt_sueldo.get()) 
        txt_incremento = float(self.txt_incremento.get())
        valor_con_porcentaje = txt_sueldo * (txt_incremento / 100)
        Resultado = txt_sueldo + valor_con_porcentaje
        alert(title="titulo ", message= str(float(Resultado)))
