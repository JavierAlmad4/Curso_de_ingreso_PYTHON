...
Al presionar el botón  'Sumar', se deberán obtener los valores contenidos en las cajas de texto
 (txt_operador_A y txt_operador_B), transformarlos 
en números enteros, realizar la suma y luego mostrar el resultado de la operación utilizando el Dialog Alert. 
...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert("Resultado", "Tu suma da como resultado: " + str(suma))
